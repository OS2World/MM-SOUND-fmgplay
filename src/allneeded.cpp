...
#include "decoder.h"
// to get list of compiled codecs
#include "config.h"
...
// only need audio decoders
#define REGISTER_ENCODER(X,x) {}
#define REGISTER_DECODER(X,x) { \
          extern AVCodec x##_decoder; \
          if (ENABLE_##X##_DECODER) register_avcodec(&x##_decoder); }
#define REGISTER_ENCDEC(X,x)  REGISTER_DECODER(X,x)
 ...
 */
int register_needed_codecs(void) {
